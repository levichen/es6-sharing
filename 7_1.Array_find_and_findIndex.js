...
// find result just return object
const find = test.find(t => t.id === 1) // { id: 1, name: 'levi' }
// find muti result then return array
const filter = test.filter(t => t.id === 1) //  [ { id: 1, name: 'levi' }, { id: 1, name: 'jean' } ]
const index = test.findIndex(t => t.id === 2) // 1
console.log(find)
console.log(filter)
console.log(index)
...
const post = posts.find(post => {
  if (post.code === code) return true
  return false
})
console.log(post)

const post1 = posts.find(post => post.code === code)
console.log(post1)
